...
using ProService.ProviderForms;
using System;
...
namespace ProService
{
    public partial class frmProviderDashboard : Form
    {
        ...
        private void btnTransactions_Click(object sender, EventArgs e)
        {
            ...
            OpenChildForm(new frmproviderTransactions());
        }

        private void btnBookings_Click_1(object sender, EventArgs e)
        {
            ActivateButton(sender, RGBColors.color3);
            OpenChildForm(new frmProviderBookings());
        }

        private void btnProfile_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, RGBColors.color5);
            OpenChildForm(new frmProviderProfile());
        }
        ...
        private void btnReceipt_Click(object sender, EventArgs e)
        {
            ...
            OpenChildForm(new frmServiceReceipt());
        }
    }
}
